package com.coremedia.labs.plugins.adapters.pixabay.service;
...
public class PixabayService {
  ...
  private Map<String, Object> toQueryParamMap(@NonNull SearchQuery searchQuery) {
    ...
    if (searchQuery instanceof PhotoSearchQuery) {
      ...
      result.put(COLORS, String.join(",", photoQuery.getColors().stream().map(Enum::toString).toArray(String[]::new)));
