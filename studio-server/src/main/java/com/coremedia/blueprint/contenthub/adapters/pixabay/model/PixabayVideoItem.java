package com.coremedia.blueprint.contenthub.adapters.pixabay.model;
...
public class PixabayVideoItem extends PixabayItem {
  ...
  public PixabayVideoItem(@NonNull ContentHubObjectId objectId, @NonNull Video video) {
    super(objectId, PixabayContentHubType.VIDEO);
    this.video = video;
  }
